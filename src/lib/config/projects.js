export const projects = [
...

  {
    ...
    description:  "Ce projet est un benchmark conçu pour évaluer les performances de différents moteurs de template JavaScript. Il permet aux développeurs de comparer les performances de rendu de plusieurs moteurs de template dans divers scénarios.",
