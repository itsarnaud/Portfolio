export const projects = [
  ...
  },
  {
    ...
    challenge:
      "Le défi était de concevoir un système de benchmark fiable et reproductible, capable de mesurer équitablement les performances de moteurs aux syntaxes et fonctionnements très différents. Il fallait également rendre le projet extensible pour que d'autres développeurs puissent contribuer en ajoutant leurs propres moteurs de templates. Le projet a attiré l'attention de la communauté avec 10 stars et des contributions externes.",
  ...
  },
  {
    ...
    challenge:
      "J'ai été chargé de la refonte visuelle complète de la plateforme ainsi que du développement de nouvelles fonctionnalités. Le défi était de moderniser l'interface utilisateur tout en conservant la simplicité d'utilisation qui fait la force du produit. Il fallait également intégrer de nouvelles features sans complexifier l'expérience utilisateur, en gardant l'accessibilité au cœur de la conception pour que même les non-initiés puissent créer leur site facilement.",
  ...
  },
  {
    ...
    challenge:
      "En tant que Chef de projet et Scrum Master, j'ai coordonné une équipe de 5 développeurs tout en contribuant activement au développement. Le défi technique majeur était la mise en place d'un système de sous-domaines dynamiques pour héberger chaque portfolio utilisateur. L'intégration de modèles 3D interactifs avec Three.js et la gestion d'une architecture full-stack (Next.js/React en frontend, Symfony en backend) dans un environnement Docker ont également représenté des challenges techniques.",
    technologies: [
      "Next.js",
      "TypeScript",
      "Symfony",
  ...
  },
  {
    ...
    challenge:
      "Le défi principal était de concevoir un outil qui réponde réellement à nos besoins sans reproduire la complexité des solutions existantes. Il fallait trouver le bon équilibre entre simplicité d'utilisation et richesse fonctionnelle. Travailler en équipe sur ce projet m'a permis de développer mes compétences en collaboration et en gestion de code partagé.",
    technologies: ["SvelteKit", "Node.js", "MySQL", "Tailwind"],
    image: [
  ...
  },
  {
    ...
    year: "2026",
    description:
      "Site vitrine premium pour une entreprise d'agencement sur-mesure.",
    longDescription:
      "Site vitrine haut de gamme conçu pour une entreprise française spécialisée dans l'architecture commerciale et l'agencement sur-mesure (pharmacies, épiceries fines, etc.). L'application offre une expérience utilisateur fluide et immersive grâce à des animations avancées au défilement et des transitions dynamiques. Le site intègre également une gestion optimisée des images de nouvelle génération, un SEO performant, ainsi qu'un formulaire de contact relié à une API personnalisée pour l'envoi d'emails transactionnels.",
    challenge:
      "Le principal défi a été d'allier un design très visuel avec des animations complexes (réalisées avec GSAP et intégrées dans des composants React) tout en maintenant de hautes performances web et un excellent référencement naturel. J'ai conçu une architecture frontend robuste tirant parti des dernières fonctionnalités de Next.js (App Router, Server Components) et géré l'intégration du service Brevo pour un système de contact fiable.",
    technologies: [
      "Next.js",
      "React",
      "TypeScript",
