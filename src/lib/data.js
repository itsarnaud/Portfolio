export const projects = [
  ...
  },
  {
    ...
    slug: 'idk-concept',
    year: '2026',
    description: 'Site vitrine premium pour une entreprise d\'agencement sur-mesure.',
    ...
    challenge: 'Le principal défi a été d\'allier un design très visuel avec des animations complexes (réalisées avec GSAP et intégrées dans des composants React) tout en maintenant de hautes performances web et un excellent référencement naturel. J\'ai conçu une architecture frontend robuste tirant parti des dernières fonctionnalités de Next.js (App Router, Server Components) et géré l\'intégration du service Brevo pour un système de contact fiable.',
