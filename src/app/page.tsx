  ...
  return (
    <>
      ...
      >
        <p
          ref={jobRef}
          className="uppercase text-sm tracking-widest mb-4 text-mono text-muted-foreground"
        >
        ...
        <h1
          ref={titleRef}
          className="text-5xl md:text-7xl lg:text-8xl font-display leading-[1.1] mb-8 text-balance"
        >
          Je crée des expériences web <span className="italic">modernes</span>{" "}
          et performantes.
        </h1>
        ...
        >
          Passionné par le développement d&apos;application web, je transforme
          vos idées en produits digitaux de qualité.
        </p>
      ...
      <section className="px-6 md:px-12 lg:px-24 py-32 border-t border-border">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-start">
          <div>
            <AnimatedText
              trigger
              className="text-3xl md:text-4xl font-display leading-snug"
            >
          ...
          <div className="space-y-6 text-muted-foreground">
            <p className="leading-relaxed">
              Depuis un peu plus de 2 ans, je conçois et développe des
              applications web complètes, du design système au déploiement en
              production.
            </p>
            <p className="leading-relaxed">
              Ma stack principale inclut React, Next.js, Node.js, Svelte,
              JavaScript, et TypeScript, mais je reste curieux et j&apos;explore
      ...
      <section className="py-32 px-6 md:px-12 lg:px-24 bg-secondary/50">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-end justify-between mb-16">
            <div>
              <p className="text-sm tracking-widest text-muted-foreground mb-2 font-mono">
