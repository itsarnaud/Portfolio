...
import { getExperiences, getEducation }         from '@/src/lib/data';
...
const ExperiencePage = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(timelineLineRef.current, { scaleY: 0, transformOrigin: "top" }, {
      ...
      <section ref={timelineRef} className="px-6 md:px-12 lg:px-24 mb-32 relative">
        ...
        <div className="max-w-6xl mx-auto space-y-16 lg:space-y-0">
          {experiences.map((exp, i) => (
            <div
              key={exp.id}
              ref={(el) => { if (el) experienceCardsRef.current[i] = el; }}
